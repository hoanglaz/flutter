...
import 'package:thingsboard_app/modules/dashboard/dashboard_main_page.dart';
...
class TbMainNavigationItem {
  ...
  static Map<Authority, Set<String>> mainPageStateMap = {
    ...
    Authority.TENANT_ADMIN:
        Set.unmodifiable(['/home', '/alarms', '/devices', '/more', '/dashboards']),
        ...
        case Authority.CUSTOMER_USER:
          items.addAll([
            ...
            TbMainNavigationItem(
                ...
                path: '/devices'),
            TbMainNavigationItem(
                page: DashboardMainPage(tbContext),
                title: 'Dashboards',
    ...
    for (var item in items) {
      switch (item.path) {
        ...
        case '/more':
          ...
          break;
        case '/dashboards':
          item.title = '${S.of(context).dashboards}';
          break;  
      }
    }
  }
